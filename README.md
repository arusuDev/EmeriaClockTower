...
- 各フェーズの切替（作業開始／休憩開始／全体完了）で、対象VCに入室して `assets/chime.mp3` を再生して合図します。
...
4. **OAuth2 → URL Generator** で以下のスコープ／権限を選択してサーバーへ招待：
   ...
   - permissions: `View Channels`, `Send Messages`, `Connect`, `Speak`, `Mute Members`
